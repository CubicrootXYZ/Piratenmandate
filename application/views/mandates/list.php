...
<h2 class="text-centered padded">Mandatsliste</h2>
...
<div class="col-sm-12">
<a href="/mandates/list" class="btn btn-danger">Suche löschen</a>
</div>
</div>
</div>
</div>
...
<div class="card shadow mb-1 <?php if ($entry['institution'] == 'Europaparlament'):?>bg-lightred<?php endif;?> <?php if ($entry['institution'] == 'Bundestag'):?>bg-lightblue<?php endif;?> <?php if (in_array($entry['institution'], ['Sonstiges kommunales Mandat', 'Bürgermeister', 'Kreistag', 'Gemeinderat'])):?>bg-lightgrey<?php endif;?> <?php if (in_array($entry['institution'], ['Sonstiges Mandat', 'Landesparlament'])):?>bg-lightgreen<?php endif;?>">
             <div class="card-body row">
                  ...
                  <a class="btn btn-outline-danger" href="/manage/mandate_remove/<?php echo html_escape($entry['mandate_id']); ?>">Eintrag entfernen <i class="fas fa-chevron-right"></i></a>
                  <?php endif;?>
                  <?php if ($this->ion_auth->in_group(['admin', 'superuser'])): ?>
                  <a  class="btn btn-danger" href="/manage/mandate_delete/<?php echo html_escape($entry['mandate_id']); ?>">Eintrag endgültig löschen <i class="fas fa-chevron-right"></i></a>
                  <?php endif;?>
                  </div>
