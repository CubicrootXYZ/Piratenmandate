 ...
 */
$config['site_title']                 = "Piratenmandate";       // Site Title, example.com
$config['admin_email']                = "mail@domain.de"; // Admin Email, admin@example.com
$config['default_group']              = 'members';           // Default group, use name do not changes this groups!!!
